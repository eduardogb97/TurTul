   ...
   <nav class="navbar navbar-expand-lg  fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="../Pago/sendpayment.aspx" style=" color:black;">Registro de empresa</a>
                </li>
                <li class="nav-item">
...
<p><a href="LugaresRegistrados.aspx" target="ventana_iframe">Enlace 1</a></p>
